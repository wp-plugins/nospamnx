	...
	{	
		...
		function checkCommentForm() {															
			if (basename($_SERVER['PHP_SELF']) != 'wp-comments-post.php') {
				...
				//check if new comment field is not post array
				if (!array_key_exists("kromment",$_POST))
					$this->birdbrained();
					
				//check if old comment field is in post array
				...
				//retranslate kromment and comment field
				$_POST['comment'] = $_POST['kromment'];
			}
		}
