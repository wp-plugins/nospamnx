	...
	{	
		...
		function nospamnxOptionPage() {	
			...
			<div class="wrap">
				...
				<div id="poststuff" class="ui-sortable">
					<div class="postbox opened">
						<h3><?php echo __('Blacklists','nospamnx'); ?></h3>
						<div class="inside">
		...
		function getOptions() {
			...
			$this->nospamnx_urlblacklist	= $options['nospamnx_urlblacklist'];
		...
		function setOptions() {
			$options = array(
				...
				'nospamnx_urlblacklist'	=> $this->nospamnx_urlblacklist			
			);
